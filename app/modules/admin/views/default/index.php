<?php
$dash = new \app\assets\DashboardAsset();

foreach ($dash->js as $js){
    $this->registerJsFile($js, ['depends'=>\app\assets\AdminAsset::className()]);
}
foreach ($dash->css as $css){
    $this->registerCssFile($css, ['depends'=>\app\assets\AdminAsset::className()]);
}
    ...
    <div class="col-lg-3 col-md-6">
        <div class="widget lightblue-1 animated fadeInDown">
            <div class="widget-content padding">
                ...
                <div class="text-box">
                    <p class="maindata">UMUMIY <b>FOYDALANUVCHILAR</b></p>
