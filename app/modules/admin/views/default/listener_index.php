...
$mg = \app\models\GroupListeners::find()
->where(['listener_id'=>Yii::$app->user->identity->getId()])
->all();
    ...
    <div class="col-lg-3 col-md-6">
        <div class="widget darkblue-2 animated fadeInDown">
            <div class="widget-content padding">
                ...
                <div class="text-box">
                    <p class="maindata"><?=$g->group->name?> </p>
                    <h2><span class="animate-number" data-value="<?=$g->group->getAllListeners();?> "
                              data-duration="3000">0</span></h2>
            ...
            <div class="widget-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <i class="fa fa"></i><?=Yii::t('app','Listeners')?> <?=$g->group->getAllListeners();?>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
