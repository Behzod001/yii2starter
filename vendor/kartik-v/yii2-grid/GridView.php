...
HTML;
     ...
     * ```
     * [
     *      ['from'=>GridView::ICON_ACTIVE, 'to'=>Yii::t('app', 'Active')],
     *      ['from'=>GridView::ICON_INACTIVE, 'to'=>Yii::t('app', 'Inactive')]
     * ]
     * ```
     */
    ...
    public function renderToggleData()
    {
        ...
        return Html::tag('div', Html::a($label, Url::to('/../../'.$lang->url.$url), $this->toggleDataOptions[$tag]), $this->toggleDataContainer);
    }
    ...
    protected function initExport()
    {
        ...
        $pdfHeader = [
            'L' => [
                'content' => Yii::t('app', 'Simplex  Grid Export (PDF)'),
                'font-size' => 8,
                'color' => '#333333'
            ],
            'C' => [
    ...
    protected function registerAssets()
    {
        ...
        if ($this->export !== false && is_array($this->export) && !empty($this->export)) {
            ...
            $gridOptsVar = 'appExp_' . hash('crc32', $gridOpts);
            ...
            foreach ($this->exportConfig as $format => $setting) {
                ...
                $genOptsVar = 'appExp_' . hash('crc32', $genOpts);
                ...
                $expOptsVar = 'appExp_' . hash('crc32', $expOpts);
        ...
        $this->_gridClientFunc = 'appInit_' . hash('crc32', $script);
